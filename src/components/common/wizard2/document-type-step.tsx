...
export default function DocumentTypeStep({ formData, setFormData }: DocumentTypeStepProps) {
  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <motion.div
        ...
        whileTap={{ scale: 0.98 }}
        className={`selection-card ${formData.documentType === "cv" ? "selected" : ""}`}
      ...
      >
        ...
        <h3 className="text-xl font-medium mb-2 text-primary dark:text-primary">Currículum Vitae</h3>
        <p className="text-center text-primary/80 dark:text-primary/80 mb-4">
          Ideal para aplicar a ofertas de trabajo y destacar tu experiencia profesional
        </p>
        ...
        >
          ...
          <span className="text-sm font-medium">Perfecto para búsqueda de empleo</span>
        </motion.div>
      ...
      <motion.div
        ...
        whileHover={{ scale: 1.05, y: -5 }}
        whileTap={{ scale: 0.98 }}
        className={`selection-card ${formData.documentType === "portfolio" ? "selected" : ""}`}
      ...
      >
        ...
        <h3 className="text-xl font-medium mb-2 text-secondary dark:text-secondary">Portfolio</h3>
        ...
        >
          <Zap className="h-4 w-4 mr-1" />
          <span className="text-sm font-medium">Ideal para creativos y freelancers</span>
        </motion.div>
