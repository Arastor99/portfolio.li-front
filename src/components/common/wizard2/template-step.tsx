...
export default function TemplateStep({
	...
	const fetchTemplates = async () => {
		...
		const templates = isCV
			? await getCVTemplates()
			: await getPotfolioTemplates()
	...
	useEffect(() => {
		...
		const imageNames =
			formData.documentType === "cv" ? imageNamesCV : imageNamesPortfolios
	...
	const getImagePath = (template: PortfolioTemplate | CVTemplate) => {
		...
		const basePath =
			formData.documentType === "cv" ? "/templatesCv" : "/templatesPortfolio"
