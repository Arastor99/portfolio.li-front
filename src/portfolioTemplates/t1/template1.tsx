  ...
  return (
    ...
    <div ref={containerRef} className="min-h-screen bg-[#030014] text-white overflow-hidden">
      ...
      <main className="relative z-10">
        {/* Hero Section */}
        <Hero handleMouseEnter={handleMouseEnter} handleMouseLeave={handleMouseLeave} scrollToSection={scrollToSection}/>
        {/* About Section */}
        <About/>
        {/* Experience Section */}
        <Experience/>
       ...
       <Education/>
        {/* Contact Section */}
        <Contact handleMouseEnter={handleMouseEnter}  handleMouseLeave={handleMouseLeave}/>
      </main>
        <Footer navItems={navItems} scrollToSection={scrollToSection} handleMouseEnter={handleMouseEnter}  handleMouseLeave={handleMouseLeave}/>
    </div>
